...
namespace PropertyManagerFL.Infrastructure.Services.JWT;
...
public class JwtService : IJwtService
{
    ...
    public string GerarToken(Utilizador utilizador)
    {
        ...
        var claims = new List<Claim>
            {
                new Claim(ClaimTypes.Name, utilizador.Login)
            };
        claims.AddRange(utilizador.Funcoes.Select(p => new Claim(ClaimTypes.Role, p.Descricao)));
