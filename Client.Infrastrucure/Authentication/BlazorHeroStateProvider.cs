...
using PropertyManagerFL.Shared.Constants.Permission;
using PropertyManagerFL.Shared.Constants.Storage;
using System;
...
namespace PropertyManagerFL.Client.Infrastructure.Authentication
{
